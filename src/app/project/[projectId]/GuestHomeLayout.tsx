  ...
  return (
    <main className="min-h-dvh bg-gray-50 dark:bg-gray-950 pb-32">
      ...
      <div className="max-w-2xl mx-auto px-4 py-5 space-y-4">
        ...
        {/* ╔═══════════════════════════════════════════╗ */}
        {/* ║  Card 2 — لیست خرج‌ها (Main Content)      ║ */}
        {/* ╚═══════════════════════════════════════════╝ */}
        {isContributor && (
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10 border border-blue-200 dark:border-blue-800 rounded-2xl p-4">
        ...
        {summary?.participantBalances && summary.participantBalances.length > 0 && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            ...
            <div className="p-4">
              ...
              {/* CTA to view full summary (if needed in future) */}
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center">
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
              می‌خوای عضو این پروژه بشی؟
            </p>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
              برای دسترسی کامل، از مدیر پروژه درخواست عضویت کن
            </p>
            <p className="text-xs text-gray-400 dark:text-gray-500">
              🔒 این دسترسی هر زمان قابل لغو است
            </p>
          </div>
        </div>
      </div>
